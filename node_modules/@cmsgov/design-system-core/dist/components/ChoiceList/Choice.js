  ...
  function Choice(props) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      if (props.inputPlacement === 'right') {
        console.warn("[Deprecated]: Please remove the 'inputPlacement' prop in <Choice>. This prop is no longer supported and will be removed in a future release.");
      }
    }
  ...
  _createClass(Choice, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          inputPlacement = _this$props.inputPlacement,
          ...
          inputProps = _objectWithoutProperties(_this$props, ["checkedChildren", "children", "className", "hint", "inversed", "inputPlacement", "inputClassName", "labelClassName", "requirementLabel", "size", "uncheckedChildren", "inputRef"]);
      ...
      }, inputProps)), _react.default.createElement(_FormLabel.default, {
        className: labelClassName,
        fieldId: this.id,
        hint: hint,
        requirementLabel: requirementLabel
      }, children), this.checked() ? checkedChildren : uncheckedChildren);
    }
  }]);
...
Choice.propTypes = {
   ...
   */
  inputPlacement: _propTypes.default.oneOf(['left', 'right']),
