...
var Button = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Button(props) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      if (props.buttonRef) {
        console.warn("[Deprecated]: Please remove the 'buttonRef' prop in <Button>, use 'inputRef' instead. This prop has been renamed and will be removed in a future release.");
      }
  ...
  _createClass(Button, [{
    ...
    value: function attrs() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["className", "component", "inputRef", "inversed", "inverse", "onClick", "size", "variation", "buttonRef"]);
    ...
    value: function render() {
      ...
      return _react.default.createElement(ComponentType, _extends({
