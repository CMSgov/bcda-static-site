...
function isTextField(child) {
  return child != null && child.type === _TextField.default;
}
/**
...
var Autocomplete = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Autocomplete, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_downshift.default, autocompleteProps, function (_ref) {
        var clearSelection = _ref.clearSelection,
            ...
            isOpen = _ref.isOpen;
        return _react.default.createElement(_WrapperDiv.default, getRootProps({
          'aria-expanded': null,
          'aria-haspopup': null,
          'aria-labelledby': null,
          'aria-owns': null,
          ...
          refKey: 'innerRef',
          role: null
        }), _this4.renderChildren(getInputProps, isOpen), isOpen && (loading || items) ? _react.default.createElement("div", {
          className: "ds-u-border--1 ds-u-padding--1 ds-c-autocomplete__list",
          id: _this4.listboxContainerId
        }, label && !loading && _react.default.createElement("h5", {
          ...
          id: _this4.listboxId,
          role: "listbox"
        }, _this4.filterItems(items, inputValue, getInputProps, getItemProps, highlightedIndex))) : null, clearSearchButton && _react.default.createElement(_Button.default, {
