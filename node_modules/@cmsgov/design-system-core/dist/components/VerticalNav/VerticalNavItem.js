...
var VerticalNavItem = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function VerticalNavItem(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(VerticalNavItem).call(this, props));
  ...
  _createClass(VerticalNavItem, [{
    ...
    value: function renderSubnav() {
      if (this.hasSubnav()) {
        return _react.default.createElement(_VerticalNav.default, {
    ...
    value: function render() {
      ...
      return _react.default.createElement("li", {
        className: classes
      }, _react.default.createElement(_VerticalNavItemLabel.default, {
...
VerticalNavItem.propTypes = {
   ...
   * sub-navigation list.
   */
  items: _propTypes.default.arrayOf(_propTypes.default.shape(VerticalNavItem.propTypes)),
