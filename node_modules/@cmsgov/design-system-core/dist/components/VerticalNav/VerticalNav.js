...
exports.default = exports.VerticalNav = void 0;
...
var VerticalNav = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(VerticalNav, _React$PureComponent);

  function VerticalNav() {
    _classCallCheck(this, VerticalNav);

    return _possibleConstructorReturn(this, _getPrototypeOf(VerticalNav).apply(this, arguments));
  }
  ...
  _createClass(VerticalNav, [{
    ...
    value: function renderItems() {
      ...
      return this.props.items.map(function (item) {
        ...
        return _react.default.createElement(_VerticalNavItem.default, _extends({}, item, {
...
VerticalNav.propTypes = {
   ...
   */
  items: _propTypes.default.arrayOf(_propTypes.default.shape(_propTypes.default.object)).isRequired,
