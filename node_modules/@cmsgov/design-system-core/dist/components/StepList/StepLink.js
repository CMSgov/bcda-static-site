...
exports.default = exports.StepLink = void 0;
...
var StepLink = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(StepLink, _React$PureComponent);

  function StepLink() {
    _classCallCheck(this, StepLink);

    return _possibleConstructorReturn(this, _getPrototypeOf(StepLink).apply(this, arguments));
  }
  ...
  _createClass(StepLink, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(ComponentType, {
        ...
        className: className
      }, children, screenReaderText && _react.default.createElement("span", {
