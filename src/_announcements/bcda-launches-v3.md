...
The v1 and v2 endpoints will be disabled on July 30, 2027. Refer to the [v3 Migration Guide]({{ '/how-to-migrate-v3' | relative_url }}) for steps and support on upgrading to v3. 