...
<figure class="width-full margin-y-4 margin-x-0" style="border: 1px solid #f0f0f0; border-radius: 4px; overflow:hidden; padding: 12px;">
  <img
    ...
    alt="Timeline of when claim data becomes available to users through BCDA and CCLF after providers submit a claim."
    class="width-full"
  >
  <figcaption class="usa-sr-only">
    <ul>
        <li>Through BCDA: a partially adjudicsted claim is available 2-4 days after submission and continues to update every 2 to 4 days while CMS is processing. Once the claim is fully adjudicated, the fully adjudicated version is available through BCDA within 1 to 7 days.</li>
