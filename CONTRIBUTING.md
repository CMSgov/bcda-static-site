...
5.  From your branch, make a pull request against `CMSgov/bcda-static-site/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `CMSgov/bcda-static-site/main`
...
bcda-static-site will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
bcda-static-site uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/CMSgov/bcda-static-site/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of bcda-static-site. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of bcda-static-site:
...
[proj-releases-new]: https://github.com/CMSgov/bcda-static-site/releases/new
-->
...
docs. Please file an [issue](https://github.com/CMSgov/bcda-static-site/issues).
-->
